	...
	return (
		<div className="mx-2 flex flex-col items-center justify-center gap-12 py-4">
			<header className="flex flex-col items-center justify-center gap-4">
				<h1 className="font-bold text-4xl">Bot Status</h1>

				<p className="max-w-md text-center text-xl leading-relaxed tracking-tighter">
					Check if the bot is online in your server or is currently having issues!
				</p>
			</header>

			<main className="flex w-full max-w-3xl flex-col items-center justify-center gap-8 rounded-lg border px-[34px] py-8">
				{data ? (
