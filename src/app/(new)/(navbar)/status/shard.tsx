...
export function ShardDisplay({ guilds, members, ping, shardId, uptime, highlight }: ShardDisplayProps) {
	...
	return (
		<>
			<TooltipAnchor
				className={clsx(
					"flex size-[50px] items-center justify-center rounded-lg border border-lrk-white/25 font-bold text-4xl",
			...
			<Tooltip
				store={tooltip}
				className="max-w-xs whitespace-pre-wrap rounded-lg border border-lrk-white/25 bg-lrk-background px-3 py-2 text-center leading-relaxed tracking-tight md:max-w-prose"
			>
