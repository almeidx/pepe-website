		...
		<div className="flex flex-col items-center gap-2 py-4">
			<header className="mt-3 flex gap-8">
				<div className="flex flex-col items-center">
					<h1 className="mb-4 font-semibold text-2xl text-lrk-white">Leveling Leaderboard</h1>

					<p className="max-w-xl px-2 text-center text-lrk-white/75 text-xl tracking-tight">
