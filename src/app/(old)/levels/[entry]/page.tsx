import { LeaderboardTable } from "@/app/(old)/levels/[entry]/01-leaderboard-table.tsx";
import { PageSelector } from "@/app/(old)/levels/[entry]/page-selector.tsx";
		...
		<div className="container mx-auto flex flex-col py-4">
			<header className="flex flex-col items-center justify-center gap-6">
				<div className="flex gap-4">
					...
					<h1 className="font-bold text-2xl text-lrk-white md:text-3xl">{guild.name}</h1>
				</div>
