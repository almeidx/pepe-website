	...
	return (
		<div className="flex flex-col items-center justify-center gap-12 py-4">
			<header className="flex flex-col items-center justify-center gap-4">
				<h1 className="font-bold text-4xl text-lrk-white">Level Calculator</h1>

				<p className="max-w-md px-2 text-center text-lrk-white/75 text-xl leading-relaxed tracking-tighter">
