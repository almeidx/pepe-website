...
import { Providers } from "@/app/(old)/providers.tsx";
...
export default function RootLayout({ children }: PropsWithChildren) {
	...
	return (
		<html lang="en">
			<body
				className={`${openSans.variable} flex min-h-screen flex-col scroll-smooth bg-lrk-background font-sans text-lrk-white antialiased selection:bg-lrk-primary selection:text-lrk-white`}
			>
				<Providers>
