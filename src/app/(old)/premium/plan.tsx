			...
			className={clsx(
				...
				tier === 1
					...
					: tier === 2
						...
						: "border border-lrk-white/25",
				isCurrent &&
					"after:-top-4 after:-translate-x-1/2 after:absolute after:left-1/2 after:rounded-lg after:bg-lrk-white after:px-4 after:py-1 after:font-bold after:text-black after:text-xl after:content-['Current']",
			)}
		>
			...
			<p className="mt-2 text-center text-lrk-white/75">{price === 0 ? "Billed never!" : "Billed recurringly"}</p>

			<div className="mt-4 space-y-3 whitespace-normal text-lrk-white/75 text-sm tracking-tighter md:text-base xl:whitespace-nowrap">
