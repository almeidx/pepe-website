import { configLimitFeatures, extraFeatures, levelingFeatures } from "@/app/(old)/premium/features";
import { PremiumPlan } from "@/app/(old)/premium/plan";
import { ComparisonTable } from "@/app/(old)/premium/table";
		...
		<div className="container mx-auto flex flex-col justify-center">
			<div className="mb-6 flex flex-col items-center gap-4 xl:gap-0">
				...
				<main className="flex w-full flex-col items-center">
					...
					<p className="max-w-prose text-balance text-center text-lrk-white/75">
