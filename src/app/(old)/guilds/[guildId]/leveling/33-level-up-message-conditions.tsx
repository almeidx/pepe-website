		...
		<>
			...
			>
				<div className="mt-2 flex items-center">
					<Label sub={`Max. ${max} levels between ${MIN_XP_ANNOUNCE_LEVEL}-${MAX_XP_ANNOUNCE_LEVEL}`}>
						Set the <span className="font-semibold text-lrk-white tracking-tight">specific</span> levels you want the
			...
			<div className="mt-2 flex items-center">
				<Label sub={`Between level ${MIN_XP_ANNOUNCE_MINIMUM_LEVEL}-${MAX_XP_ANNOUNCE_MINIMUM_LEVEL}`}>
					Set the <span className="font-semibold text-lrk-white tracking-tight">minimum</span> level you want the level
			...
			<div className="mt-2 flex items-center">
				<Label sub={`Between level ${MIN_XP_ANNOUNCE_MULTIPLE_OF}-${MAX_XP_ANNOUNCE_MULTIPLE_OF}`}>
					Set the <span className="font-semibold text-lrk-white tracking-tight">factor</span> for levels you want the
					level up message to be sent at…
				</Label>
