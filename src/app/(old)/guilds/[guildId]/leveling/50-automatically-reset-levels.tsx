	...
	return (
		<div className="space-y-2">
			<label className="flex items-center gap-2" htmlFor="autoResetLevelsLeave">
				...
				<p className="text-lg text-lrk-white/75 tracking-tight md:text-xl">When the user leaves</p>
			</label>
			...
			<label className="flex items-center gap-2" htmlFor="autoResetLevelsBan">
				...
				<p className="text-lg text-lrk-white/75 tracking-tight md:text-xl">When the user is banned</p>
			</label>
		</div>
	);
}
