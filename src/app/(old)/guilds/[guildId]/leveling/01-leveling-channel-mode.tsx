...
export function LevelingChannelMode({ defaultValue }: { readonly defaultValue?: XpChannelMode }) {
	...
	return (
		<RadioGroup className="flex w-fit flex-col gap-4" store={radio}>
			<label className="flex text-lg text-lrk-white/75 tracking-tight md:text-xl" htmlFor="xpChannelModeWhitelist">
			...
			<label className="flex text-lg text-lrk-white/75 tracking-tight md:text-xl" htmlFor="xpChannelModeBlacklist">
