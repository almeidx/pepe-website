...
export function LevelUpMessageEmbed({ defaultValue, emojis, roles }: LevelUpMessageEmbedProps) {
	...
	return (
		<div className="flex flex-col">
			<Disclosure
				className={clsx(
					"flex max-w-3xl items-center justify-between gap-1 border border-lrk-white/25 bg-dark-gray px-2 py-1.5 hover:bg-dark-gray/50",
			...
			<DisclosureContent
				className="flex max-w-3xl flex-col rounded-b-lg border border-lrk-white/25 bg-dark-gray px-2 py-1.5"
				store={disclosure}
			>
				<EmbedBuilder
