	...
	return (
		<>
			...
			<div className="flex flex-wrap items-center gap-3">
				<p className="text-lg text-lrk-white/75 tracking-tight md:text-xl">Select your role: </p>
				...
				<p className="text-lg text-lrk-white/75 tracking-tight md:text-xl">and the level to reward it at: </p>
				...
				<button
					...
					type="button"
				>
					<AddComment className="size-6 text-lrk-white" />
				</button>
			</div>
...
function RoleRewardDisplay({ id, level, premium, roleIds, onDelete, roles }: RoleRewardDisplayProps) {
	...
	return (
		<div className="flex items-center gap-4">
			<button
				className="group relative flex size-9 items-center justify-center rounded-lg border border-lrk-white bg-[#1e1f22] text-[#fff]"
				onClick={() => onDelete(id)}
				type="button"
			>
				<div className="absolute hidden size-9 items-center justify-center rounded-lg border border-lrk-white bg-[#1e1f22] group-hover:flex">
