import { getGuildSettings } from "@/app/(old)/guilds/[guildId]/get-guild-data.ts";
...
export default async function Roles({ params }: { readonly params: Promise<{ guildId: Snowflake }> }) {
	...
	return (
		...
		>
			...
			>
				<Text>
					Automatically assign <span className="font-semibold text-lrk-white">every</span> user who joins a role(s)…
				</Text>
