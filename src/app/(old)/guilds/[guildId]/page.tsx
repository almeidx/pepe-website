		...
		<div className="mb-4 flex flex-col p-4">
			<div className="flex h-fit gap-5">
				...
				<div>
					...
					<p className="whitespace-pre-wrap text-lrk-white/75 text-xl tracking-tighter">
			...
			<h3 className="mt-10 mb-4 flex items-center gap-2 font-semibold text-2xl">
				...
				/>
				<span className="ml-2 inline-block rounded-full bg-red px-2 font-bold text-lrk-white text-sm uppercase">
					BETA
				</span>
			</h3>

			<p className="text-lrk-white/75 text-xl tracking-tighter">Click on the glowing options to find out more!</p>
