...
import type { GuildInfo } from "@/app/(old)/guilds/page";
		...
		<>
			...
			<div className="my-7 flex max-w-2xl flex-wrap justify-center gap-12">
				{filteredGuilds.map((guild, idx) => (
					...
					>
						<div
							className="-left-11 -top-14 invisible absolute z-50 w-40 rounded-lg bg-darker px-3 py-2 text-lrk-white shadow-md outline outline-1 outline-lrk-white/25 group-focus-within:visible group-hover:visible"
							role="tooltip"
						>
