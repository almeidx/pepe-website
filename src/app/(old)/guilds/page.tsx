import { DashboardGuildList } from "@/app/(old)/guilds/guild-list";
	...
	return (
		<div className="flex flex-col items-center gap-2 py-4">
			<header className="mt-3 flex gap-8 px-4 md:px-0">
				...
				<div>
					<h1 className="mb-4 font-semibold text-2xl text-lrk-white">{greeting(user.globalName ?? user.username)}</h1>

					<p className="text-lrk-white/75 text-xl tracking-tight">
