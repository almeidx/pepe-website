	...
	return (
		<>
			...
			<Dialog
				...
				className="-translate-x-1/2 fixed top-20 left-1/2 z-[100002] scale-95 rounded-lg border border-lrk-white/25 bg-dark-gray px-4 py-3 opacity-0 transition-[opacity,transform] duration-150 ease-in-out data-[enter]:scale-100 data-[enter]:opacity-100"
				portal={!useSubmitButton}
			>
				<DialogHeading className="mb-4 font-bold text-xl">{buttonText}</DialogHeading>

				<DialogDescription className="mb-4 text-lrk-white/75">{children}</DialogDescription>
